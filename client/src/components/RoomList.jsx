...
const rooms = [
    {
        id: 1,
        name: 'Java Discussion ☕',
        src: './rooms-images/java1.png',
        description: 'A community for Java Developer to share information,experiences,and support each other.'
    },
...

    {
        ...
        description: 'Those who love accounting in books, and often discuss and share their experiences with others.'
    },

    {
        id: 5,
        name: 'Engineers 🚀',
        src: './rooms-images/engineer.png',
        description: 'A group of individuals who love to engage in engineering and design discussions.'
    },

    {
        id: 6,
        name: 'Accounting 📊',
        src: './rooms-images/account.png',
        description: ' An accounting forum is an online community or platform where individuals, professionals, students, and enthusiasts gather to discuss various topics related to accounting. '
    },
